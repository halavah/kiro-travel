...
import { ArrowLeft, Ticket, Calendar, Clock, User, Phone, Loader2, ShoppingCart } from "lucide-react"
    ...
    try {
      ...
      const response = await fetch('/api/cart', {
        ...
        body: JSON.stringify({
          ...
          quantity: quantity,
          note: `访问日期: ${visitDate}, 访问时间: ${visitTime}, 联系人: ${contactName}, 电话: ${contactPhone}${note ? ', 备注: ' + note : ''}`
        })
      })
      ...
      if (result.success) {
        toast.success('已添加到购物车，请前往购物车结算')
        router.push('/cart')
      } else {
              ...
              <Card className="sticky top-4">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    ...
                    size="lg"
                    className="w-full"
                    disabled={submitting || !selectedTicketId || (selectedTicket && selectedTicket.stock === 0)}
                  >
                    {submitting ? (
                      <>
