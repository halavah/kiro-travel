...
export function ActivitiesFilter({ activityTypes }: ActivitiesFilterProps) {
  ...
  const handleTypeChange = (value: string) => {
    router.push(`/activities?${createQueryString({ type: value === "all" ? null : value })}`)
  }
  ...
  const hasFilters = searchParams.get("search") || searchParams.get("type") || searchParams.get("sort")
